    ...
    <section className="w-full text-white pt-24 pb-20 overflow-hidden relative" ref={heroRef}>
      ...
      >
        <div className="relative max-w-6xl w-full rounded-xl border border-white/10 shadow-2xl ">
          ...
          <div className="absolute -top-12 left-1/2 -translate-x-1/2 w-3/4 h-32 bg-[#1bf1a1]/30 blur-[60px] rounded-full pointer-events-none z-50"></div>

          <div className="relative max-w-6xl w-full rounded-xl border border-white/10 shadow-2xl  overflow-hidden">
